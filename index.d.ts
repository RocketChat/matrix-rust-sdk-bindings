...
export class SledBackedOlmMachine {
  ...
  get userId(): string
  get deviceId(): string
  get deviceDisplayName(): string | null
  get identityKeys(): Record<string, any>
  get outgoingRequests(): Array<string>
  getDevice(userId: string, deviceId: string): Device | null
  ...
  receiveSyncChanges(
    ...
    keyCounts: Record<string, any>,
    unusedFallbackKeys?: Array<string> | undefined | null,
  ): string
